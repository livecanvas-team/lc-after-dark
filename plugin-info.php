...
function lc_after_dark_info_page() {
    ...
    <div class="wrap" style="max-width: 900px; font-size: 16px;">
        ...
        <ul style="line-height: 1.7;">
            <li>Adds a <strong>💾 Screen Saver</strong> menu to the admin bar</li>
            <li>Manual launch of fullscreen retro animations</li>
            <li>Automatically triggers after 2 minutes of inactivity</li>
            <li>Exits cleanly with a <strong>click</strong> or <strong>any key press</strong></li>
        </ul>
        ...
        <p>
            ...
            <a href="https://github.com/brianhan/after-dark-css" target="_blank"><strong>after-dark-css</strong></a> project by Brian Brown —
        ...
        <p>
            This plugin is a side project built for fun by the team at LiveCanvas. It’s open source, nostalgia-fueled,
            and meant to bring a smile to your WP admin sessions.
        </p>

        <hr style="margin: 40px 0;" />

        <div style="text-align: center; padding: 20px 30px; background: #f9f9f9; border-radius: 12px;">
            <a href="https://livecanvas.com" target="_blank" style="text-decoration: none; color: inherit;">
                <div style="display: inline-block; margin-bottom: 10px;">
                    <!-- Inline LiveCanvas Logo SVG -->
                ...
                <div style="font-size: 1.1em; font-weight: 600;">Built by LiveCanvas</div>
                <div style="color: #555;">The most professional visual HTML builder for WordPress</div>
            </a>
        </div>

        <h3 style="margin-top: 50px;">📄 License & Credits</h3>
        <ul style="line-height: 1.7;">
            <li>Plugin: GPLv2 or later</li>
            <li>Animations: MIT License - <a href="https://github.com/brianhan/after-dark-css" target="_blank">after-dark-css by Brian Brown</a></li>
        </ul>
    </div>
