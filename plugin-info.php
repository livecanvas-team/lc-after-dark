...
function lc_after_dark_info_page() {
    ...
    <div class="wrap" style="max-width: 900px; font-size: 16px;">
        ...
        <ul style="line-height: 1.7;">
            <li><i>Screen Saver is activated for logged site admins only </i> - unlogged users untouched</i></li>
        ...
        <div style="text-align: center; padding: 20px 30px; background: #f9f9f9; border-radius: 12px;">
            <style>
                a#lc-link:focus     {box-shadow:none!important}
            </style>
            <a id="lc-link" href="https://livecanvas.com" target="_blank" style="text-decoration: none; color: inherit;">
                <div style="display: inline-block; margin-bottom: 10px;">
                    <div style="font-size: 1.1em; font-weight: 600;margin-bottom: 10px;">Brought to you by the LiveCanvas Team</div>
                ...
                <div style="color: #555;">The professional page builder for WordPress</div>
            </a>
        </div>
        ...
        <ul style="line-height: 1.7;">
            ...
            <li>Animations: MIT License - <a href="https://github.com/bryanbraun/after-dark-css" target="_blank">after-dark-css by Brian Brown</a></li>
        </ul>
    </div>
